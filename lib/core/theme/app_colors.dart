...
class AppColors {
  static const Color primario = Color(0xFF194629);
  static const Color secundario = Color(0xFF00A86B);

  //Fondo principal es Color.white
  static const Color fondoSecundario = Color(0xFFF6F8F7);
  ...
  //Texto claroPrincipal es Color.white
  static const Color textoClaro = Color(0xFFF6F8F7);
}